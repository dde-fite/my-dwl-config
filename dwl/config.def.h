...
/* tagging */
static char *tags[] = { "Browsing", "Coding", "Terminals", "Music", "Other" };
...
static const Rule rules[] = {
	...
	//{ "firefox",		NULL,       	0,		0,	     	-1 }, /* Start on ONLY tag "9" */
	//{ "brave",		NULL,       	0,		0,	     	-1 }, /* Start on ONLY tag "9" */
	//{ "spotify-launcher",	NULL,       	0,		0,	     	-1 }, /* Start on ONLY tag "9" */
};
...
static const MonitorRule monrules[] = {
	...
	{ "eDP-1",   	0.5f,  	1,      1,    	&layouts[0], 	WL_OUTPUT_TRANSFORM_NORMAL,	1,	0},
	{ "HDMI-1",   	0.5f,  	1,      1,    	&layouts[0], 	WL_OUTPUT_TRANSFORM_NORMAL,	0,	0},
	/* defaults */
